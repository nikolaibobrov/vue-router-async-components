	    ...
	    if (typeof def === 'function' && !def.options) {
	      return function (route, redirect, next) {
	        var resolve = function (resolvedDef) {
						...
						//may be a bug,In webpack - Simple template generated by the project,
            // The resolve  function is called twice, at the time of the last call  the value of the resolvedDef parameter is undifined,
            // Lead to subsequent requests for the same component was terminated
	          if (resolvedDef) {
